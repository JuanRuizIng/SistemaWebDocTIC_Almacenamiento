...
-- -----------------------------------------------------
-- Table `SistemaWebDocTICSchema`.`Responde`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `SistemaWebDocTICSchema`.`Responde` (
  `idResponde` INT NOT NULL AUTO_INCREMENT,
  `ComenResp` VARCHAR(500) NOT NULL,
  `fechaResp` DATETIME NOT NULL,
  `idComentario` INT NOT NULL,
  `idUsuario` INT NOT NULL,
  PRIMARY KEY (`idResponde`),
  INDEX `fk_Responde_Comentario1_idx` (`idComentario` ASC) VISIBLE,
  INDEX `fk_Responde_Usuario1_idx` (`idUsuario` ASC) VISIBLE,
  CONSTRAINT `fk_Responde_Comentario1`
    FOREIGN KEY (`idComentario`)
    REFERENCES `SistemaWebDocTICSchema`.`Comentario` (`idComentario`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Responde_Usuario1`
    FOREIGN KEY (`idUsuario`)
    REFERENCES `SistemaWebDocTICSchema`.`Usuario` (`idUsuario`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
-- -----------------------------------------------------
-- Table `SistemaWebDocTICSchema`.`Asociado`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `SistemaWebDocTICSchema`.`Asociado` (
  `idAsociado` INT NOT NULL AUTO_INCREMENT,
  `idDocumento` INT NOT NULL,
  `idCategoria` INT NOT NULL,
  PRIMARY KEY (`idAsociado`),
  INDEX `fk_Asociado_Documento1_idx` (`idDocumento` ASC) VISIBLE,
  INDEX `fk_Asociado_Categoria1_idx` (`idCategoria` ASC) VISIBLE,
  CONSTRAINT `fk_Asociado_Documento1`
    FOREIGN KEY (`idDocumento`)
    REFERENCES `SistemaWebDocTICSchema`.`Documento` (`idDocumento`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Asociado_Categoria1`
